...
def __add_options(parser):
    ...
    g.add_argument(
        '--osx-info-plist', dest='info_plist_path',
        help='Path to Info.plist file for Mac OS X .app bundle. '
        'Properties from specified .plist file will be '
        'merged with defaults generated by PyInstaller.',
    )
...
def main(
    ...
    **_kwargs
    ...
    d = {
        ...
        # Property list for application (macOS only)
